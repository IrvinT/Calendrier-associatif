...
$(document).ready(function(){
	...
	fadein_left = jQuery('#htmlcontent_top li.htmlcontent-item-1');
	...
	left_animate = TweenMax.from(fadein_left, 0.9, {alpha: 0, rotationY:-180, ease:Power1.easeOut},{alpha: 1, rotationY:0, ease:Power1.easeOut});
	bottom_animate = TweenMax.from(fadein_bottom, 0.9, {alpha: 0, rotationY:-180, ease:Power1.easeOut},{alpha: 1, rotationY:0, ease:Power1.easeOut});
  	right_animate = TweenMax.from(fadein_right, 0.9, {alpha: 0, rotationY:-180, ease:Power1.easeOut},{alpha: 1, rotationY:0, ease:Power1.easeOut});
  	left_animate_1 = TweenMax.from(fadein_left_1, 0.9, {alpha: 0, rotationY:-180, ease:Power1.easeOut},{alpha: 1, rotationY:0, ease:Power1.easeOut});
	bottom_animate_1 = TweenMax.from(fadein_bottom_1, 0.9, {alpha: 0, rotationY:-180, ease:Power1.easeOut},{alpha: 1, rotationY:0, ease:Power1.easeOut});
  	right_animate_1 = TweenMax.from(fadein_right_1, 0.9, {alpha: 0, rotationY:-180, ease:Power1.easeOut},{alpha: 1, rotationY:0, ease:Power1.easeOut});
