    ...
    {else}
        ...
        <form action="{$link->getPageLink('identity', true)|escape:'html':'UTF-8'}" method="post" class="std">
            <fieldset>
                ...
                <!-- ADD ASSOC -->
                <div class="required form-group">
                    <label for="assoc" class="required">
                        {l s='assoc'} 
                    </label>
                    <input class="is_required validate form-control" data-validate="isName" type="text" name="assoc" id="assoc" value="{$smarty.post.assoc}" />
                </div>
                <!-- - - - - - - - - - -->
