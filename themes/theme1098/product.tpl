        ...
        {if !$content_only}<div class="left-part{if $columns == 2} col-sm-12 col-md-8{elseif $columns == 3} col-xs-12{else} col-sm-8 col-md-9 col-lg-9{/if}">
        	<div class="row">{/if}
                ...
                <div class="pb-right-column col-xs-6">
                    ...
                    {* <form id="buy_block"{if $PS_CATALOG_MODE && !isset($groups) && $product->quantity > 0} class="hidden"{/if} action="{$link->getPageLink($order_process, true)|escape:'html':'UTF-8'}" method="post"> *}
