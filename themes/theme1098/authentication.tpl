			...
			<div class="box">
				<div id="opc_account_form" style="display: block; ">
					...
					<!-- ADD "assoc" -->
					 <!-- 
						<div class="required form-group">
							<label for="assoc">{l s='assoc'} <sup>*</sup></label>
							<input type="text" class="is_required validate form-control" data-validate="isName" id="assoc" name="assoc" value="{if isset($smarty.post.assoc)}{$smarty.post.assoc}{/if}" />
						</div>
 					 -->
					<!-- ----- -->
					...
					<div id="opc_invoice_address"  class="unvisible">
						...
						<!-- ADD ASSOC -->
						<!-- 
							{elseif $field_name eq "assoc"}
							<div class="required form-group">
								<label for="assoc_invoice">{l s='Last name'} <sup>*</sup></label>
								<input type="text" class="form-control" id="assoc_invoice" name="assoc_invoice" value="{if isset($guestInformations) && $guestInformations.assoc_invoice}{$guestInformations.assoc_invoice}{/if}" />
							</div>
							 -->
						<!-- -------- -->
	...
	<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="account-creation_form" class="std box">
		...
		<div class="account_creation">
			...
			<!-- ADD "assoc" -->
				...
				<div class="required form-group">
					<label for="assoc">{l s='assoc'} <sup>*</sup></label>
					<input onkeyup="$('#assoc').val(this.value);" type="text" class="is_required validate form-control" data-validate="isName" id="assoc" name="assoc" value="{if isset($smarty.post.assoc)}{$smarty.post.assoc}{/if}" />
				</div>
				...
				{foreach from=$dlv_all_fields item=field_name}
					...
					<!-- 
						{elseif $field_name eq "assoc"}
							<p class="required form-group">
								<label for="assoc">{l s='assoc'} <sup>*</sup></label>
								<input type="text" class="form-control" id="assoc" name="assoc" value="{if isset($smarty.post.assoc)}{$smarty.post.assoc}{/if}" />
							</p>
					 -->
					<!-- ----- -->
