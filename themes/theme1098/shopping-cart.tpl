		...
		<table id="cart_summary" class="table table-bordered {if $PS_STOCK_MANAGEMENT}stock-management-on{else}stock-management-off{/if}">
			<thead>
				<tr>
					...
					{/if}
					<th class="cart_unit item">{l s='Unit price'} <sup>TTC</sup></th>
					<th class="cart_quantity item">{l s='Qty'}</th>
					<th class="cart_total item">{l s='Total'} <sup>TTC</sup></th>
							...
							<tr
								...
								<td class="cart_quantity" colspan="2">
									...
									{else}
										...
										<!-- <select class="cart_quantity_input form-control grey" name="quantity_{$product.id_product}_{$product.id_product_attribute}_{$id_customization}_{$product.id_address_delivery|intval}">
			                                <option>100</option>
			                                <option>150</option>
			                                <option>200</option>
			                                <option>250</option>
			...
			{hook h="displayCartRuleShoppingCart" discounts=$discounts}
                                {if sizeof($discounts)}
				<tbody>
