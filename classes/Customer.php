...
class CustomerCore extends ObjectModel
{
    ...
    public static $definition = array(
        ...
        'fields' => array(
            ...
            'assoc' =>                    array('type' => self::TYPE_STRING, 'validate' => 'isName', 'required' => true, 'size' => 32),
    ...
    {
        $sql = 'SELECT `id_customer`, `email`, `firstname`, `lastname`, `assoc`
    ...
    public static function searchByName($query, $limit = null)
    {
        ...
        $sql .= ' UNION ('.$sql_base.' WHERE `assoc` LIKE \'%'.pSQL($query).'%\' '.Shop::addSqlRestriction(Shop::SHARE_CUSTOMER).')';
    ...
    public function transformToCustomer($id_lang, $password = null)
    {
        ...
        if ($this->update()) {
            ...
            Mail::Send(
                ...
                $vars,
                $this->email,
                $this->firstname.' '.$this->lastname.' at '.$this->assoc,
                null,
                null,
                null,
                null,
