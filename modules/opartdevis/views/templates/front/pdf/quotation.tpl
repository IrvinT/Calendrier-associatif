...
<div style="font-size: 8pt; color: #444">
    ...
    <table cellpadding="3">
        ...
        <tr>
            <td>{$message_visible}</td>{* HTML needed can't escape *}
        </tr>
        <tr><td>&nbsp;</td></tr>
    </table>
    {/if}
    ...
    <table>
        ...
        <tr style="font-weight:bold;">
            <td>{$freeText}</td>{* HTML needed can't escape *}
        </tr>
    </table>
    <table>
           <tr><td>&nbsp;</td></tr>
    ...
    <table>
        ...
        <tr style="font-weight:bold;">
            <td>{$validationText}</td>{* HTML needed can't escape *}
        </tr>
    </table>
    <table>
        <tr>
        ...
        <tr>
            <td style="text-align: right; font-weight:bold">{$goodforagrementText}</td>{* HTML needed can't escape *}
        </tr>
    </table>
</div>