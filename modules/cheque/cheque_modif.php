...
class Cheque extends PaymentModule
{
	...
	public function hookPaymentReturn($params)
	{
		...
		{
			// Add pour CALENDRIER ASSOCIATIF : DEUX CHÈQUES :
			// Impossible de l'ajouter à l'override... 
			setlocale(LC_MONETARY, 'fr_FR');

			$cheque1 = money_format('%n', ($params['total_to_pay'] * 0.3));
			$cheque2 = money_format('%n', ($params['total_to_pay'] - $cheque1));
			// ----  FIN de modification
