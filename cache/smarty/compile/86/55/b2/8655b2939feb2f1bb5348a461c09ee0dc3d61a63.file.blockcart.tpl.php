<?php /* Smarty version Smarty-3.1.19, created on 2016-06-16 10:28:55
         compiled from "/srv/data/web/vhosts/test.calendrier-associatif.com/htdocs/prestashop/themes/theme1098/modules/blockcart/blockcart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:940666706576263473ac7a1-44875112%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8655b2939feb2f1bb5348a461c09ee0dc3d61a63' => 
    array (
      0 => '/srv/data/web/vhosts/test.calendrier-associatif.com/htdocs/prestashop/themes/theme1098/modules/blockcart/blockcart.tpl',
      1 => 1465897591,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '940666706576263473ac7a1-44875112',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_576263478689b0_78698605',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_576263478689b0_78698605')) {function content_576263478689b0_78698605($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/srv/data/web/vhosts/test.calendrier-associatif.com/htdocs/prestashop/tools/smarty/plugins/modifier.replace.php';
if (!is_callable('smarty_function_counter')) include '/srv/data/web/vhosts/test.calendrier-associatif.com/htdocs/prestashop/tools/smarty/plugins/function.counter.php';
?><!-- MODULE Block cart -->
<?php if (isset($_smarty_tpl->tpl_vars['blockcart_top']->value)&&$_smarty_tpl->tpl_vars['blockcart_top']->value) {?>
<div class="div7 clearfix<?php if ($_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?> header_user_catalog<?php }?>">
<?php }?>
...
">&nbsp;</a>
						...
						<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>"displayCartRuleBlockCart",'discounts'=>$_smarty_tpl->tpl_vars['discounts']->value),$_smarty_tpl);?>
...
"></span>
			...
			<div class="layer_cart_cart col-xs-12 col-md-6">
				...
				<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>"displayCartRuleLayerCart",'discounts'=>$_smarty_tpl->tpl_vars['discounts']->value),$_smarty_tpl);?>
